 ...
 * @param [pictureLeft] A boolean that specifies whether the image should be on the left or right.
 * @param [priority] A boolean that specifies whether the image should be loaded immediately.
